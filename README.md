# Vector Off-Chain Metadata Registry

This is the off-chain metadata registry for Vector **mainnet**.
...
1. Submissions to the registry must consist of a single commit, directly off the **main** branch of the **vector-token-registry** repository.
